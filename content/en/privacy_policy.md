...
The web server (HostGator) automatically collects technical information when you access our site, including:
...
{{< external_link url="https://info.orcid.org/privacy-policy/" text="ORCID Privacy Policy" >}}  
{{< external_link url="https://auth0.com/docs/secure/data-privacy-and-compliance" text="Auth0 Privacy Policy" >}}
...
## Duration of storage
Log data: up to 14 days  
Login data (via ORCID/Auth0): as long as you maintain your account with us  
Longer storage may occur if required by law (e.g., tax or legal retention periods).  
No additional personal data is permanently stored on our servers.  
